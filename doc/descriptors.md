# Support for Output Descriptors in Faithcoin Core

Since Faithcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Faithcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Faithcoin Core wallets, a convenience function `combo` is

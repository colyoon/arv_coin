...
const char * const BITCOIN_CONF_FILENAME = "arvcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Arvcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Arvcoin";
#else
    // Unix
    return pathRet / ".arvcoin";
#endif
#endif
}

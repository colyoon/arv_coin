...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.arvcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.arvcointools.com");
        vSeeds.emplace_back("dnsseed.arvcoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xf8, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xf8, 0x88, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.arvcointools.com");
        vSeeds.emplace_back("seed-b.arvcoin.loshan.co.uk");

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " arvcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  arvcoin-tx [options] <hex-tx> [commands]  Update hex-encoded arvcoin transaction\n" +
            "or:     arvcoin-tx [options] -create [commands]   Create hex-encoded arvcoin transaction\n" +
            "\n";

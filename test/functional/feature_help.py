...
"""Verify that starting arvcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start arvcoin with -h for help text")
        ...
        self.log.info("Start arvcoin with -version for version information")
        ...
        self.log.info("Start arvcoind with -fakearg to make sure it does not start")
